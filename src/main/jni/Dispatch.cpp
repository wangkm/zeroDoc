 ...
 * does not have com.jacob2.com.Dispatch in its classpath
 */
JNIEXPORT jobject JNICALL Java_com_jacob2_com_Dispatch_QueryInterface
  (JNIEnv *env, jobject _this, jstring _iid)
{
  ...
  // jacob2-msg 1817 - SF 1053871 :  QueryInterface already called AddRef!!
  //if (disp) disp->AddRef();
 ...
 **/
JNIEXPORT void JNICALL Java_com_jacob2_com_Dispatch_createInstanceNative
 ...
 **/
JNIEXPORT void JNICALL Java_com_jacob2_com_Dispatch_getActiveInstanceNative
  (JNIEnv *env, jobject _this, jstring _progid)
{
  jclass clazz = env->GetObjectClass(_this);
  jfieldID jf = env->GetFieldID( clazz, DISP_FLD, "I");
 ...
 * This exists solely for the factory method connectToActiveInstance.
 **/
JNIEXPORT void JNICALL Java_com_jacob2_com_Dispatch_coCreateInstanceNative
  (JNIEnv *env, jobject _this, jstring _progid)
{
  jclass clazz = env->GetObjectClass(_this);
  jfieldID jf = env->GetFieldID( clazz, DISP_FLD, "I");
 ...
 * release method
 */
JNIEXPORT void JNICALL Java_com_jacob2_com_Dispatch_release
...
JNIEXPORT jintArray JNICALL Java_com_jacob2_com_Dispatch_getIDsOfNames
 ...
 const char* methName)
{
  ...
  else
  {
    ...
    // jacob2-msg 1075 - SF 1053872 : Documentation says "use LocalFree"!! 
    //delete msg2;
	LocalFree(msg2); 
  }
  delete methNameW;
...
JNIEXPORT jobject JNICALL Java_com_jacob2_com_Dispatch_invokev
  ...
  jint lcid, jint wFlags, jobjectArray vArg, jintArray uArgErr)
{
  ...
  switch (wFlags) 
  {
    ...
    case DISPATCH_PROPERTYPUTREF: // jacob2-msg 1075 - SF 1053872
      {
