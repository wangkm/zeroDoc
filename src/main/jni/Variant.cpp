  ...
  (JNIEnv *env, jobject _this)
{
  ...
  if (v) 
  {
    ...
    jclass autoClass = env->FindClass("com/jacob2/com/EnumVariant");
    jmethodID autoCons =
  ...
  (JNIEnv *env, jobject _this)
{
  ...
  if (v) {
    ...
    jclass autoClass = env->FindClass("com/jacob2/com/Dispatch");
    jmethodID autoCons =
    env->GetMethodID(autoClass, "<init>", "(I)V");
  ...
  (JNIEnv *env, jobject _this, jboolean deepCopy)
{
  ...
  if (v) {
    ...
    jclass saClass = env->FindClass("com/jacob2/com/SafeArray");
...
// removed Java_com_jacob2_com_Variant_putSafeArrayRefHelper
